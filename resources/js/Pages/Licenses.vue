...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-12 flex items-center justify-between">
            ...
            <button @click="router.get(route('store'))" class="px-8 py-3 bg-brand-teal text-slate-900 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-brand-teal/20 hover:scale-105 transition-all">
                New License
            </button>
        </div>
