                        ...
                        <td class="px-8 py-6 text-[10px] font-black uppercase tracking-widest leading-none">
                            <div class="flex items-center gap-2">
                                <template v-if="order.gateway === 'bkash'">
                                    <svg class="w-3.5 h-3.5 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a1 1 0 001 1h16a1 1 0 001-1V7a1 1 0 00-1-1H4a1 1 0 00-1 1zM3 7l9 6 9-6" /></svg>
                                    <span class="text-pink-600 dark:text-pink-400">bKash</span>
                                </template>
